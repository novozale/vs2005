    ...
    Private Sub DiscountGroup_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If StartParam = "Edit" Then
            ...
            If Declarations.MyRec.EOF = True And Declarations.MyRec.BOF = True Then
                MsgBox("Выделенная скидка на группу товаров не найдена, возможно удалена другим пользователем. закройте и откройте по новой вкладку скидок на группы товаров.", MsgBoxStyle.Critical, "Внимание!")
                trycloseMyRec()
                Me.Close()
            Else
