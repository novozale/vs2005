    ...
    Private Sub DiscountItem_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If StartParam = "Edit" Then
            ...
            If Declarations.MyRec.EOF = True And Declarations.MyRec.BOF = True Then
                MsgBox("Выделенная скидка на товар не найдена, возможно удалена другим пользователем. закройте и откройте по новой вкладку скидок на товары.", MsgBoxStyle.Critical, "Внимание!")
                trycloseMyRec()
                Me.Close()
            Else
        ...
        If Trim(TextBox1.Text) <> "" Then
            ...
            Else
                If Declarations.MyRec.Fields("SubGroupCode").Value = "" Then
                    MsgBox("Для данного кода товара не назначена подгруппа. Скидка на такие товары вводится не может", MsgBoxStyle.Critical, "Внимание!")
                    Label3.Text = ""
                    e.Cancel = True
                    trycloseMyRec()
                    Exit Sub
            ...
            Else
                ...
                Else
                    If Declarations.MyRec.Fields("CC").Value <> 0 Then
                        MsgBox("На данный товар данному покупателю уже выставлена скидка. Воспользуйтесь функцией редактирования скидки.", MsgBoxStyle.Critical, "Внимание!")
                        trycloseMyRec()
                        Exit Sub
                    Else
                        trycloseMyRec()
