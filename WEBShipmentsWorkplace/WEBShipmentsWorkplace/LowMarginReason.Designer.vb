...
Partial Class LowMarginReason
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Укажите причину разрешения на отгрузку с низкой маржой"
        '
        'LowMarginReason
        '
        ...
        Me.Name = "LowMarginReason"
        Me.Text = "Причина отгрузки с низкой маржой"
        Me.TopMost = True
