...
MyCatch:
    ...
    Public Function GetFirstPartFromStr(ByVal MyName As String) As String
        '////////////////////////////////////////////////////////////////////////////////
        '//
        '// получение первой части строки до пробела
        '//
        '////////////////////////////////////////////////////////////////////////////////
        ...
        If MyCodeLength <= 0 Then
            GetFirstPartFromStr = ""
        Else
            GetFirstPartFromStr = Mid(MyName, 1, MyCodeLength)
        End If
    End Function
End Module
