Public Class ContactInfo
    ...
    Private Sub ContactInfo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Label2.Text = Trim(MainForm.DataGridView1.SelectedRows.Item(0).Cells(4).Value.ToString()) + " " + Trim(MainForm.DataGridView1.SelectedRows.Item(0).Cells(5).Value.ToString())
        End If
        LoadData()
        CheckButtons()
    End Sub
