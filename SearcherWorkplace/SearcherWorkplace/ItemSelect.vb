Public Class ItemSelect
    ...
    Public Function DataPreparation()
        ...
        DataGridView1.Columns(7).HeaderText = "Всего на складах"
        DataGridView1.Columns(7).Width = 115
        DataGridView1.Columns(8).HeaderText = "Поставщик ID"
        DataGridView1.Columns(8).Width = 70
        DataGridView1.Columns(9).HeaderText = "Поставщик"
