Public Class SendInfo
    ...
    Private Sub SendInfo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If MyShipmentsList.DataGridView1.SelectedRows.Item(0).Cells(3).Value = "Самовывоз" Then
        ...
        ElseIf MyShipmentsList.DataGridView1.SelectedRows.Item(0).Cells(3).Value = "Доставка с оплатой клиентом" Then
            ComboBox1.SelectedText = "Доставка с оплатой клиентом"
        Else
            ComboBox1.SelectedText = "Доставка"
        End If
        TextBox3.Text = Declarations.MyCustomerCode
        '-----EMail (в зависимости от конфигурации)
        If MyEmail = 1 Then
            ...
            MySQLStr = MySQLStr & "AND ('Контактное лицо: ' + tbl_CRM_Contacts.ContactName + ' Телефон: ' + tbl_CRM_Contacts.ContactPhone + ' E-Mail: ' + tbl_CRM_Contacts.ContactEMail "
