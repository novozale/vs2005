Public Class EditProduct
    ...
    Private Sub EditProduct_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Подгружаем информацию из выбранной строки в DataGridView2
        TextBox1.Text = Trim(MainForm.DataGridView2.SelectedRows.Item(0).Cells(2).Value.ToString())
        TextBox2.Text = Trim(MainForm.DataGridView2.SelectedRows.Item(0).Cells(3).Value.ToString())
