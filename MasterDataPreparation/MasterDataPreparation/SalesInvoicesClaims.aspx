<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SalesInvoicesClaims.aspx.vb" Inherits="MasterDataPreparation.SalesInvoicesClaims" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Номера СФ на продажу, по которым были претензии</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <h2 style="color: navy; font-family: Arial">&nbsp;&nbsp; Учет претензий от покупателей 
        </h2>
                        ...
                        <tr style="width: 100%">
                            <td style="vertical-align:top; ">
                                <div style="width: 98%; height: 100%; border-left-color: navy; border-bottom-color: navy; border-top-style: outset; border-top-color: navy; border-right-style: outset; border-left-style: outset; border-right-color: navy; border-bottom-style: outset; position: static; left: 0px; top: 0px;">
                                    <h2 style="color: navy; font-family: Arial">&nbsp;&nbsp; Номера СФ на продажу, по которым были претензии</h2>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Номер СФ на продажу, по которой была претензия">
                                            <ItemTemplate>
                                                <%#Eval("SalesInvoiceNum")%>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <EditItemTemplate>
                                                <asp:TextBox runat="server" ID="SalesInvoiceNum" Text='<%# Bind("SalesInvoiceNum") %>' Width="100%"/>
                                            </EditItemTemplate>
                                            </EditItemTemplate>
                                       </asp:TemplateField>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=sqlcls;Initial Catalog=ScaDataDB;Persist Security Info=True;User ID=sa;Password=sqladmin"
                                        SelectCommand="SELECT     ID, SalesInvoiceNum&#13;&#10;FROM         tbl_SalesInvoicesClaims" ProviderName="System.Data.SqlClient" DeleteCommand="DELETE FROM tbl_SalesInvoicesClaims WHERE (ID = @ID)" InsertCommand="INSERT INTO tbl_SalesInvoicesClaims&#13;&#10;                      (ID, SalesInvoiceNum)&#13;&#10;VALUES     (NEWID(),@InsertSalesInvoiceNum)" UpdateCommand="UPDATE    tbl_SalesInvoicesClaims&#13;&#10;SET              SalesInvoiceNum = @SalesInvoiceNum&#13;&#10; WHERE (ID = @ID)">
                                        <DeleteParameters>
                                            <asp:ControlParameter ControlID="GridView1" Name="ID" PropertyName="SelectedValue" />
                                        </DeleteParameters>
                                        <UpdateParameters>
                                            <asp:Parameter Name="SalesInvoiceNum" />
                                            <asp:Parameter Name="ID" />
                                        </UpdateParameters>
                                        <InsertParameters>
                                            <asp:Parameter Name="InsertSalesInvoiceNum" />
                                        </InsertParameters>
                                    </asp:SqlDataSource>
                                </div>
                            </td>
                                   ...
                                   <table style="width: 100%;">
                                       <tr style="width: 100%;">
                                            <td style="width: 33%; height: 26px;">
                                                Номер СФ на продажу, по которой была претензия
                                            </td>
                                            <td style="width: 33%; height: 26px; text-align: center;">
                                                <asp:TextBox runat="server" ID="InsertSalesInvoiceNum" Width="90%"/>
                                            </td>
                                            <td style="width: 34%; height: 26px; text-align: left;">
