<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RexelProductType.aspx.vb" Inherits="MasterDataPreparation.RexelProductType" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Типы товаров Rexel</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <h2 style="color: navy; font-family: Arial">&nbsp;&nbsp; Классификация типов товаров Rexel 
        </h2>
                        ...
                        <tr style="width: 100%">
                            <td style="vertical-align:top; ">
                                <div style="width: 98%; height: 100%; border-left-color: navy; border-bottom-color: navy; border-top-style: outset; border-top-color: navy; border-right-style: outset; border-left-style: outset; border-right-color: navy; border-bottom-style: outset; position: static; left: 0px; top: 0px;">
                                    <h2 style="color: navy; font-family: Arial">&nbsp;&nbsp; Типы товаров Rexel</h2>
                                    <asp:GridView ID="GridView1" runat="server" style="width: 100%; font-family: Arial; font-size: x-small;" AllowPaging="True" AutoGenerateColumns="False" CellPadding="3" DataSourceID="SqlDataSource1" ForeColor="Black" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" PageSize="20" DataKeyNames="SRPGCode">
                                    <Columns>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=sqlcls;Initial Catalog=ScaDataDB;Persist Security Info=True;User ID=sa;Password=sqladmin"
                                        SelectCommand="SELECT SRPGCode, RussianName, EnglishName FROM tbl_RexelProductType ORDER BY SRPGCode" ProviderName="System.Data.SqlClient" DeleteCommand="DELETE FROM tbl_RexelProductType WHERE (SRPGCode = @SRPGCode) AND (SRPGCode NOT IN  (SELECT  ISNULL(SRPGCode, '') AS SRPGCode FROM tbl_RexelProductCategory                GROUP BY SRPGCode))" InsertCommand="INSERT INTO  tbl_RexelProductType (SRPGCode, RussianName, EnglishName) VALUES  (@SRPGCode, @RussianName, @EnglishName)" UpdateCommand="UPDATE  tbl_RexelProductType SET  RussianName = @RussianName, EnglishName = @EnglishName WHERE  (SRPGCode = @SRPGCode)">
                                        <DeleteParameters>
                                            <asp:ControlParameter ControlID="GridView1" Name="SRPGCode" PropertyName="SelectedValue" />
                                        </DeleteParameters>
                                        <UpdateParameters>
                                ...
                                <div style="width: 98%; height: 100%; border-left-color: navy; border-bottom-color: navy; border-top-style: outset; border-top-color: navy; border-right-style: outset; border-left-style: outset; border-right-color: navy; border-bottom-style: outset; position: static; left: 0px; top: 0px; background-color:#cccccc; text-align: right;">
                                   <table style="width: 100%;">
                                       <tr style="width: 100%;">
                                            ...
                                            <td style="width: 15%;">
                                                <asp:TextBox runat="server" ID="InsertSRPGCode" Width="100%"/>
                                            </td>
                                            <td style="width: 15%;">
                                                Название
                                            </td>
