Public Partial Class LT_And_OI_Item_Settings
    ...
    Protected Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        SqlDataSource1.InsertParameters("LT").DefaultValue = 0
        SqlDataSource1.InsertParameters("ManualLT").DefaultValue = InsertLT.Text
    ...
    Private Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            If (e.Row.DataItem("LT") = 0) And (e.Row.DataItem("ManualLT") = 0) Then
