<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ServiceLevelCoeff.aspx.vb" Inherits="MasterDataPreparation.ServiceLevelCoeff" %>
...
<head id="Head1" runat="server">
    <title>Настройка расчетного коэффициента уровня сервиса</title>
</head>
<body>
    ...
    <div style="color: navy; font-family: Arial; font-weight: bold; font-size: 14pt;">
        ...
        <br />
        Настройка расчетного коэффициента уровня сервиса<br />
                ...
                <td colspan="3" rowspan="3" style="height: 200px; width: 100%;">
                    <asp:GridView ID="GridView1" runat="server" style="width: 100%; font-family: Arial; font-size: x-small;" AutoGenerateColumns="False" CellPadding="3" DataSourceID="SqlDataSource1" ForeColor="Black" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" DataKeyNames="ID">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Коэффициент уровня сервиса">
                                <EditItemTemplate>
                                    <asp:TextBox ID="LT" runat="server" Text='<%# Bind("ServiceLevelCoeff") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <%#Eval("ServiceLevelCoeff")%>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ScaDataDBConnectionString %>"
                        ...
                        SelectCommand="SELECT     ID, ABC, XYZ, ServiceLevelCoeff FROM  tbl_ForecastOrder_ServiceLevelCoeff"
                        UpdateCommand="UPDATE  tbl_ForecastOrder_ServiceLevelCoeff SET ServiceLevelCoeff = @ServiceLevelCoeff&#13;&#10;WHERE (ID = @ID)">
                        <UpdateParameters>
                            <asp:Parameter Name="@ID" />
                            <asp:Parameter Name="@ServiceLevelCoeff" />
                        </UpdateParameters>
                    </asp:SqlDataSource>
                </td>
            </tr>
