...
MyCatch:
    ...
    Public Function GetSQLStrng(ByVal SRCSQLStr As String) As String
        '/////////////////////////////////////////////////////////////////////////////////////
        '//
        '// получение данных для параметра SQL запроса без спецсимволов
        '// 
        '/////////////////////////////////////////////////////////////////////////////////////

        SRCSQLStr = Replace(SRCSQLStr, "'", "''")

        GetSQLStrng = SRCSQLStr
    End Function
End Module
