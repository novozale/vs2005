    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If MyPlace = "List" Then
            If AttType = "Sales" And WhoStart = "Sales" Then
                MySearchSupplier.DataGridView1.SelectedRows.Item(0).Cells(15).Value = DataGridView1.RowCount
            End If
            If AttType = "Search" And WhoStart = "Search" Then
                MySearchSupplier.DataGridView1.SelectedRows.Item(0).Cells(16).Value = DataGridView1.RowCount
            End If
        End If
        Me.Close()
    End Sub
