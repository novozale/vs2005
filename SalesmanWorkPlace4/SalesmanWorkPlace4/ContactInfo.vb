Public Class ContactInfo
    ...
    Private Sub ContactInfo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Label2.Text = Trim(MyEditRequest.TextBox1.Text) + " " + Trim(MyEditRequest.TextBox2.Text)
        LoadData()
        CheckButtons()
    End Sub
    ...
    Private Sub LoadData()
        ...
        MySQLStr = MySQLStr & "WHERE (tbl_CRM_Companies.ScalaCustomerCode = '" & Trim(MyEditRequest.TextBox1.Text) & "') "
    ...
    Private Sub ContactSelect()
        ...
        MyEditRequest.TextBox3.Text = Trim(Me.DataGridView1.SelectedRows.Item(0).Cells(2).Value.ToString())
        MyEditRequest.TextBox4.Text = Trim(Me.DataGridView1.SelectedRows.Item(0).Cells(3).Value.ToString())
        MyEditRequest.TextBox5.Text = Trim(Me.DataGridView1.SelectedRows.Item(0).Cells(4).Value.ToString())
        Me.Close()
    End Sub
End Class